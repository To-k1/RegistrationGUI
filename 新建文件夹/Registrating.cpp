...
void CntPoint(Mat& srcImage, Mat& dstImage, vector<vector<Point>>& pts, double rho_h, double theta_h, double th_h)
{
	//【1】载入原始图和Mat变量定义   
...
bool Registrating1Pic(Mat& M, String FnSrc, String fnImg1, String FnFi, bool flagM, bool failed, String FnMid1, String FnMid2, String fnRefImg)
{
	//用于记录失败的图片
...
bool Registrating1PicSemi(Mat& M, String FnSrc, String fnImg1, String FnFi, bool flagM, bool succeed, String FnMid1, String FnMid2, String fnRefImg)
{
	//IMG1:二值图，refimg：参考二值图，src：原图，dst：结果图
